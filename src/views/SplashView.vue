      ...
      >
        ...
        <div class="mosquito-wrap" ref="mosquitoWrap" id="mosquitoWrap">
          <div class="flutter">
            ...
            >
              <ellipse cx="46" cy="58" rx="26" ry="14" fill="rgba(79,95,214,.28)" transform="rotate(-24 46 58)"/>
              <ellipse cx="76" cy="62" rx="26" ry="14" fill="rgba(126,217,87,.28)" transform="rotate(18 76 62)"/>
